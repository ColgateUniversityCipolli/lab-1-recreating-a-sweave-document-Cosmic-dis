...
\item Create a GitHub account here, and email me you username.
...
\end{kframe}
\end{knitrout}
The result is 40.9821424. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
