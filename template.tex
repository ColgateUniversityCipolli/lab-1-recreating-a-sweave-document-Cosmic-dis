...
\end{kframe}
\end{knitrout}
The result is 40.9196733. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
\end{center}
\end{table}
The \texttt{palmerpenguins} package for \texttt{R} (Horst et al., 2020) provides data on adult foraging penguins near Palmer Station,
