...
\end{kframe}
\end{knitrout}
The result is 40.9107031. Note that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
\columnbreak
\subsection{Tables}
Below, we load and take a peek at some data about the death rate per 1000 in Virginia in 1940 \citep{molyneaux1947differences}.
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\end{center}
\end{table}
The \texttt{palmerpenguins} package for \texttt{R} \citep{horst2020palmer} provides data on adult foraging penguins near Palmer Station,
